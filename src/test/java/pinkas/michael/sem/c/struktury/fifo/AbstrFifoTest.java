...
import pinkas.michael.sem.c.struktury.fifo.AbstrFifoException;
import pinkas.michael.sem.c.struktury.fifo.IAbstrFifo;
...
public class AbstrFifoTest {
    ...
    private IAbstrFifo<TestData> abstrLifo;

    @Before
    public void setUp() {
        abstrLifo = new AbstrFifo<>();
    }
    ...
    private static boolean jeOcekavanyObsahZasobniku(TestData[] ocekavane, IAbstrFifo<TestData> vysledek) {
    ...
    public void abstrLifoTest_vloz_prazdnaData_1() {
        ocekavanaVyjimka.expect(AbstrFifoException.class);
    ...
    public void abstrLifoTest_odeber_prazdnaData_1() {
        ocekavanaVyjimka.expect(AbstrFifoException.class);
        ocekavanaVyjimka.expectMessage("Fronta neobsahuje žádné prvky");
